...
def distilling_search(trainer, train_loader, val_loader, test_loader):
    wandb.init(entity="peter-blohm-tu-wien", project="mnist_distill_local_wowowo_v3")
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = get_loaders('mnist', val_split=0.2, batch_size=128, flatten=True)
    ...
    sweep_id = wandb.sweep(entity="peter-blohm-tu-wien", project="mnist_distill_local_wowowo_v3", sweep=sweep_configuration)
